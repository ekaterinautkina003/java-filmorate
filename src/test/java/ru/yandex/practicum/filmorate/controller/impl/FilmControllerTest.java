...
public class FilmControllerTest extends ControllerTest {
    ...
    void add() {
        ...
        mockMvc.perform(put(FILM_REQUEST_MAPPING + "/add")
    ...
    void update() {
        ...
        mockMvc.perform(post(FILM_REQUEST_MAPPING + "/update")
                        .contentType(MediaType.APPLICATION_JSON).content(jsonFilm))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString(jsonFilm)));
    }
    ...
    @SneakyThrows
    void getAll() {
        mockMvc.perform(get(FILM_REQUEST_MAPPING + "/getAll"))
                .andExpect(status().isOk());
    }
